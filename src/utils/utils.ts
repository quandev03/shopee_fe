...
export function isAxiosErrorUnprocessableEntity<FormError>(
  error: unknown
...
export function isAxiosErrorUnauthorized<UnauthorizedError>(
  error: unknown
...
export function isExpiredTokenError<ExpriredError>(
  error: unknown
): error is AxiosError<ExpriredError> {
  return (
    isAxiosErrorUnauthorized<
      ResponseErrorType<{ message: string; name: string }>

    ...
    addToCartMutation.mutate(body, {
      onSuccess: () => {
        ...
        queryClient.invalidateQueries({
          queryKey: ["purchasesCart", { status: purchasesStatus.inCart }],
        });
      },
    });
  };
  ...
  return (
    ...
    <div className="relative bg-gray-100 py-3">
          ...
          <div className="col-span-7">
            ...
            <div className="my-4 flex items-center">
              <div className="flex items-center gap-1">
                <span className="mt-1 text-orange underline">
                  {product.rating}
                </span>
                <ProductRating
              ...
              <div>
                ...
                <span className="ml-1 text-sm capitalize text-gray-500">
                  {t("sold")}
                </span>
              </div>
            </div>
            ...
            <div className="flex items-center bg-gray-100 px-6 py-4">
              ...
              <div className="ml-5 rounded-sm bg-orange px-1 text-sm font-semibold uppercase text-white">
                <span>
                  {saleRate(Number(product.price), Number(product.price))}{" "}
                </span>
                {t("off")}
              </div>
            </div>
      ...
      <div className="container mt-4 bg-white">
        <div className="bg-gray-100/40 p-3 text-lg uppercase">

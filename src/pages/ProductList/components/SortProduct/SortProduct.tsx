      ...
      <div className="grid grid-cols-6 items-center gap-3">
        ...
        <button
          className={classNames(
            "col-span-1 rounded-sm px-3 py-2 capitalize shadow-sm outline-none",
            {
              "bg-orange text-white hover:bg-orange/70": isActiveSort(
                sortBy.view
              ),
        ...
        <select
          value={order || ""}
          className={classNames(
            "col-span-2 h-9 rounded-sm border-none px-2 outline-none",
            {
              "bg-orange text-white hover:bg-orange/70": isActiveSort(
                sortBy.price
              ),

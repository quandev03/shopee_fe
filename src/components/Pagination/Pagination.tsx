...
export default function Pagination({ page, limit, queryConfig }: Props) {
    const renderPagination = () => {
        ...
        return Array(limit)
            ...
            .map((_, index) => {
                ...
                if (page <= RANGE * 2 + 1 && pageNum > page + RANGE && pageNum <= limit - RANGE) {
                    ...
                    } else if (pageNum > page + RANGE && pageNum <= limit - RANGE) {
                        return renderDotsAfter(index);
                    }
                } else if (page >= limit - RANGE * 2 && pageNum > RANGE && pageNum < page - RANGE) {
                    return renderDotsBefore(index);
                }
